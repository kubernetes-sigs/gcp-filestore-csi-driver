...
type AddonsConfig struct {
	...
	// GcpFilestoreCsiDriverConfig: Configuration for the Compute Engine
...
// GcpFilestoreCsiDriverConfig: Configuration for the Compute
// Engine PD CSI driver.
type GcpFilestoreCsiDriverConfig struct {
	// Enabled: Whether the Compute Engine Filestore CSI driver is enabled
	// for this cluster.
	Enabled bool `json:"enabled,omitempty"`
