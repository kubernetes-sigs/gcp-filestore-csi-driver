...
func TestExtractInstanceLabels(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:   "Parsing labels in storageClass fails",
			driver: testDriverName,
			params: map[string]string{
				ParamMultishareInstanceScLabel: "testsc",
		...
		{
			name:   "storageClass labels contain reserved metadata labels",
			driver: testDriverName,
			params: map[string]string{
				ParamMultishareInstanceScLabel: "testsc",
		...
		{
			name:   "storageClass labels parameter not present",
			driver: testDriverName,
			params: map[string]string{
				ParamMultishareInstanceScLabel: "testsc",
			},
