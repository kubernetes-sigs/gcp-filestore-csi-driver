...
type MultishareV1Interface interface {
...
// NewForConfig creates a new MultishareV1Client for the given config.
...
// NewForConfigAndClient creates a new MultishareV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MultishareV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &MultishareV1Client{client}, nil
}

// NewForConfigOrDie creates a new MultishareV1Client for the given config and
